...
function TweenColor3(instance, property, color)
    local tweenInfo = TweenInfo.new(0.5) -- Change the duration as needed
    local tween = TweenService:Create(instance, tweenInfo, { [property] = color })
    tween:Play()
end

function lib:SetBackgroundColor(r, g, b)
    TweenColor3(Main, "BackgroundColor3", Color3.fromRGB(r, g, b))
    TweenColor3(Intro, "BackgroundColor3", Color3.fromRGB(r, g, b))
end

function lib:SetTitleColor(r, g, b)
    TweenColor3(Title, "TextColor3", Color3.fromRGB(r, g, b))
end

function lib:SetCloseBtnColor(r, g, b)
    TweenColor3(Close, "TextColor3", Color3.fromRGB(r, g, b))
    TweenColor3(Img_2, "TextColor3", Color3.fromRGB(r, g, b))
    TweenColor3(Check, "BackgroundColor3", Color3.fromRGB(r, g, b))
end

function lib:SetButtonsColor(r, g, b)
    TweenColor3(Toggle, "BackgroundColor3", Color3.fromRGB(r, g, b))
    TweenColor3(Button, "BackgroundColor3", Color3.fromRGB(r, g, b))
    TweenColor3(ComboElem, "BackgroundColor3", Color3.fromRGB(r, g, b))
    TweenColor3(ComboBox, "BackgroundColor3", Color3.fromRGB(r, g, b))
end

function lib:SetTheme(theme)
    if theme == "Default" then
        -- No color changes for the default theme
